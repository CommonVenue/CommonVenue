    ...
    <div class="row h-100 no-gutters">
      <div class="col-lg-8 site_login_bg">
            ...
            <div class="site_alerady_account_wrap">
              <div class="site_absoute_logo"><a href="/"><img src="public/images/logo.png" class="img-fluid"></a></div>
            </div>
          ...
          <div class="site_login_box">
            <div class="site_alerady_account_wrap">
              <ul class="list-inline">
                <li class="list-inline-item mr-4">Don't have an account?</li>
                <li class="list-inline-item"><a href="/register">Sign up</a></li>
              </ul>
            </div>
            <div class="site_form_title_box mb-4">
              <h3 class="site_login_title mb-0">Sign in</h3>
            </div>
            <form class="site_access_form" novalidate="" method="POST" action="{{ route('login') }}">
              @csrf
              <div class="row mb-4">
                <div class="col">
              ...
              <div class="row mb-4">
                <div class="col-lg-6">
                  <div class="site_terms_check form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineCheckbox1">{{ __('Stay signed in') }}</label>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="site_forgot_link">

		...
		<div class="row no-gutters">
			...
			<div class="col-lg-6">
				<div class="site_venue_space_detail_content bg-light">
					...
					<div class="mb-4">
						<form class="form-edit-add" method="POST" action="/properties/{{ $property->id }}/booking/{{ $booking->id }}">
			            	@csrf
			            	@method('PUT')
							...
							<div class="row">
								<div class="col-lg-3">
									<label>Date</label>
									<input type="date" class="form-control rounded-0" name="date" value="{{ $booking->date }}">
									<input type="hidden" class="form-control rounded-0" name="total_price" value="{{ $booking->total_price }}">
								</div>
								<div class="col-lg-3">
									<label>Start</label>
									<input type="time" class="form-control rounded-0" name="from_date" value="{{ $booking->from_date }}">
								</div>
								<div class="col-lg-3">
									<label>End</label> 
									<input type="time" class="form-control rounded-0" name="to_date" value="{{ $booking->to_date }}">
